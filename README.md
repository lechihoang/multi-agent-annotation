...
# Use --batch-delay 60 (or more) to avoid 429 errors on free tiers
./venv/bin/python scripts/run_arq_batch.py --input data/unlabeled.csv --rate 30 --max 0 --batch-delay 60
```
