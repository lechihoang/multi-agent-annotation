    ...
    try:
        ...
        if reached_agreement:
            ...
            if config.dream.escalation.use_llm_adjudicator:
                ...
                # Human escalation (use_llm_adjudicator=false - rarely used)
                logger.warning(f"[DREAM] Escalating to human (no adjudicator): {task_id}")
                ...
                return DreamResult(
                    ...
                    final_label="",
                    confidence=0.0,
                    reasoning="ESCALATED_TO_HUMAN - No adjudicator used",
                    reached_agreement=False,
                    debate_rounds=debate_rounds,
                    used_adjudicator=False,
                    needs_human=True,
